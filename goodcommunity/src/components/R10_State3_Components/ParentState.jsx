...
/**
 React 에서 매우 중요한 상태 끌어올리기(Lifting State Up) Pattern

 부모 컴포넌트가 모든 데이터(상태)와 그 데이터를 변경하는 함수를 가지고 있고,
 그 자식 컴포넌트(ChildIdState, ChildPwState) 는 부모로부터 그 함수를 전달받아
 실행만 하는 구조이며,
...
const ParentState = () => {
    ...
    return (
        <>
            ...
            ChildIdState 컴포넌트 내부에서는 idHandler 라는 기능을 전달 받을 때
